...
message_label.grid(row=3, column=0, sticky=tk.W, padx=5, pady=5)

message_entry = ttk.Entry(main_frame)
message_entry.grid(row=3, column=1, sticky=tk.W, padx=5, pady=5)
...
disconnect_button.grid(row=5, column=0, columnspan=2, pady=10)

received_messages_text = scrolledtext.ScrolledText(main_frame, wrap=tk.WORD)
received_messages_text.grid(row=6, column=0, columnspan=2, padx=5, pady=5)
